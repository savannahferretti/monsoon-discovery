...
if __name__=='__main__':
    ...
    thetaerot  =  0.562*thetae+0.827*thetaestar
    ...
    thetaerot  = calculator.interpolate_to_sigma(thetaerot,ps,sigs)
    ...
    dslist = [
        ...
        calculator.create_dataset(thetaerot,'thetaerot','Rotated equivalent potential temperature','K'),
